...
export default function FullClearanceCostStep() {
    ...
    return (
        <Grid container spacing={2}>
            <Grid item xs={12} sm={6}><InputField name="cpc" label="CPC" type="number" /></Grid>
            <Grid item xs={12} sm={6}><InputField name="valuation" label="Valuation" type="number" /></Grid>
            <Grid item xs={12} sm={6}><InputField name="customs_duty" label="Customs Duty" type="number" /></Grid>
            <Grid item xs={12} sm={6}><InputField name="comet_shipping" label="Comet/Shipping" type="number" /></Grid>
            <Grid item xs={12} sm={6}><InputField name="terminal_charges" label="Terminal Charges" type="number" /></Grid>
